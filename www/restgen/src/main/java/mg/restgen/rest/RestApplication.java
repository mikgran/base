...
public class RestApplication extends ResourceConfig {
    ...
    public RestApplication() {
        ...
        // TOIMPROVE: add annotations for service classes that should register
        // TOIMPROVE: RestGen: call Services.register("<packageName>"); -> scan all classes in that package, and register the
