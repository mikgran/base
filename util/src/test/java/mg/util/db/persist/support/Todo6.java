...
@Table(name = "todos6")
public class Todo6 extends Persistable {

    @Id
    private long id = 0;

    @OneToMany
    private List<Location6> locations = new ArrayList<>();

    @ForeignKey(references = "persons6", field = "id")
    ...
    public Todo6(String todo) {
        this.todo = todo;
    }

    public Todo6(String todo, List<Location6> locations) {
        this.todo = todo;
        this.locations = locations;
    }

    public Todo6(String todo, long personsId) {
        this.todo = todo;
    ...
    public List<Location6> getLocations() {
        return locations;
    }
